      ...
      <section className="relative">
        ...
        {featuredPost.metadata.image &&
          <div className="absolute inset-0 h-128 pt-16 box-content -z-1">
            <Image className="absolute inset-0 w-full h-full object-cover opacity-25" src={featuredPost.metadata.image} width={1440} height={577} priority alt={featuredPost.metadata.title} />
                    ...
                    {featuredPost.metadata.author && (
                      <div className="flex items-center justify-center">
                        ...
                        <div>
                          ...
                          <a className="font-medium text-gray-800 dark:text-gray-300 hover:underline" href="#0">{featuredPost.metadata.author}</a>
                          <span className="text-gray-600 dark:text-gray-400"> · <PostDate dateString={featuredPost.metadata.publishedAt} /></span>
                        </div>
                      </div>
                    )}
                  </div>
