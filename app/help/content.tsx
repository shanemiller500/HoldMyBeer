          ...
          <div data-aos="fade-up" data-aos-delay="450">
            ...
            <div className="mb-10">
              <div className="flex flex-wrap justify-center -m-1">
                ...
                <button
                  className={`font-medium px-4 py-2 bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 shadow transition duration-150 ease-in-out rounded-full inline-flex items-center justify-center m-1 ${category === '1' &&
                ...
                >
                  ...
                  <span
                    className={`transition duration-150 ease-in-out ${category === '1' ? 'text-white dark:text-teal-400' : 'text-gray-600 dark:text-gray-300'
                      }`}
                  >
                    AI Powered tools
                  </span>
                ...
                <button
                  className={`font-medium px-4 py-2 bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 shadow transition duration-150 ease-in-out rounded-full inline-flex items-center justify-center m-1 ${category === '2' &&
                ...
                >
                  ...
                  <span
                    className={`transition duration-150 ease-in-out ${category === '2' ? 'text-white dark:text-purple-400' : 'text-gray-600 dark:text-gray-300'
                      }`}
                  >
                ...
                <button
                  className={`font-medium px-4 py-2 bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 shadow transition duration-150 ease-in-out rounded-full inline-flex items-center justify-center m-1 ${category === '3' &&
                ...
                >
                  ...
                  <span
                    className={`transition duration-150 ease-in-out ${category === '3' ? 'text-white dark:text-indigo-400' : 'text-gray-600 dark:text-gray-300'
                      }`}
                  >
                    Templates
                  </span>
                ...
                <button
                  className={`font-medium px-4 py-2 bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 shadow transition duration-150 ease-in-out rounded-full inline-flex items-center justify-center m-1 ${category === '4' &&
                ...
                >
                  ...
                  <span
                    className={`transition duration-150 ease-in-out ${category === '4' ? 'text-white dark:text-pink-400' : 'text-gray-600 dark:text-gray-300'
                      }`}
                  >
                    Project Settings
                  </span>
