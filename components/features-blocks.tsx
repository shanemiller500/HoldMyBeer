    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          {/* Items */}
          <div className="max-w-xs mx-auto sm:max-w-none md:max-w-xl lg:max-w-none grid sm:grid-cols-3 gap-4 lg:gap-6 lg:grid-cols-3" data-aos-id-featbl>

            {/* 1st item */}
            <a className="flex flex-col p-5 group text-white bg-gradient-to-tr from-teal-500 to-teal-400 dark:to-teal-500 shadow-2xl" href="https://u-mail.ai" data-aos="fade-down" data-aos-anchor="[data-aos-id-featbl]">
              ...
              <div className="font-red-hat-display text-xl font-black tracking-tighter mb-1">UMail.ai</div>
              <div className="grow opacity-80 mb-4">A clutter free sponsered free smart Email Client, ready to intergrade with your Gmail Account. (Microsoft soon)</div>
            ...
            {/* 2nd item */}
            <a className="flex flex-col p-5 group text-white bg-gradient-to-tr from-purple-500 to-purple-400 dark:to-purple-500 shadow-2xl" href="https://applypro.ai" data-aos="fade-down" data-aos-anchor="[data-aos-id-featbl]" data-aos-delay="100">
              <svg className="w-8 h-8 mb-3" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="font-red-hat-display text-xl font-black tracking-tighter mb-1">ApplyPro.ai</div>
              <div className="grow opacity-80 mb-4">Researched backed Cover Letters & Tailered Resumes in seconds! </div>
              <svg className="w-6 h-6 self-end transform -translate-x-2 group-hover:translate-x-0 transition duration-150 ease-in-out" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path className="fill-current" d="M13 11V5.057L22.72 12 13 18.943V13H2v-2h11zm2 4.057L19.28 12 15 8.943v6.114z" />
              </svg>
            </a>
            ...
            {/* 3rd item */}
            <a className="flex flex-col p-5 group text-white bg-gradient-to-tr from-indigo-500 to-indigo-400 dark:to-indigo-500 shadow-2xl" href="/about" data-aos="fade-down" data-aos-anchor="[data-aos-id-featbl]" data-aos-delay="200">
              <svg className="w-8 h-8 mb-3" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="font-red-hat-display text-xl font-black tracking-tighter mb-1">AI Allergy Check App (2025)</div>
              <div className="grow opacity-80 mb-4">No name yet, not giving much detail, but if you check labels you will love it!</div>
              <svg className="w-6 h-6 self-end transform -translate-x-2 group-hover:translate-x-0 transition duration-150 ease-in-out" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path className="fill-current" d="M13 11V5.057L22.72 12 13 18.943V13H2v-2h11zm2 4.057L19.28 12 15 8.943v6.114z" />
              </svg>
            </a>
            ...
            {/* 4th item */}
            {/* <a className="flex flex-col p-5 group text-white bg-gradient-to-tr from-pink-500 to-pink-400 dark:to-pink-500 shadow-2xl" href="/about" data-aos="fade-down" data-aos-anchor="[data-aos-id-featbl]" data-aos-delay="300">
              <svg className="w-8 h-8 mb-3" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="font-red-hat-display text-xl font-black tracking-tighter mb-1">Simpler Sharing</div>
