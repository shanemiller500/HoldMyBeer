...
import AboutImage02 from '@/public/images/69.jpg'
import AboutImage05 from '@/public/images/70.jpg'
import AboutImage06 from '@/public/images/72.jpg'
        ...
        <div className="pt-6 pb-12 md:pt-8 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              We do. No ads, no tracking, no selling your data. <span className="text-teal-500 font-semibold">Just apps that actually work.</span>
            </p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid grid-cols-2 gap-4 gap-y-8 sm:gap-8 md:grid-cols-4 items-start md:max-w-5xl">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">Founded in 2024</div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">400 + Daily Active Users</div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">800,000 + Websites visits</div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">A lot more to come</div>
            </div>
          ...
          <div className="grid grid-cols-12 gap-3 mt-12 md:mt-20" data-aos-id-gallery>
            ...
            <div className="col-span-3 relative h-48 overflow-hidden rounded-lg" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="100">
              <Image className="object-cover" src={AboutImage02} fill sizes="25vw" alt="About grid 02" />
            </div>
            <div className="col-span-5 relative h-48 overflow-hidden rounded-lg" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="400">
              <Image className="object-cover" src={AboutImage05} fill sizes="42vw" alt="About grid 05" />
            </div>
            <div className="col-span-4 relative h-48 overflow-hidden rounded-lg" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="500">
              <Image className="object-cover" src={AboutImage06} fill sizes="33vw" alt="About grid 06" />
            </div>
