        ...
        <div className="pt-6 pb-12 md:pt-8 md:pb-20">
          ...
          <div className="max-w-sm mx-auto grid grid-cols-2 gap-4 gap-y-8 sm:gap-8 md:grid-cols-4 items-start md:max-w-5xl">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">500,000 + Websites visits</div>
            </div>
          ...
          <Image className="col-span-3" src={AboutImage02} width={270} height={200} alt="About grid 02" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="100" />
