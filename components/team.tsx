...
import { FaLinkedinIn } from 'react-icons/fa6'; // Import LinkedIn icon from React Icons
              ...
              <div className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down" data-aos-anchor="[data-aos-id-team]">
                <div className="flex flex-col items-center">
                  ...
                  <Link 
                    ...
                    aria-label="LinkedIn"
                    onClick={() => handleLinkedInClick('Shane Miller')} // Attach the onClick handler here
                  >
                    {/* Using React Icons for LinkedIn */}
                    <FaLinkedinIn 
                      size={24} 
