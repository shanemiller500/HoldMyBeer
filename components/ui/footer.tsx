      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-16 border-t border-gray-200 dark:border-gray-800 -mt-px">
          ...
          <p className='text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 px-5 py-2 flex items-center transition duration-150 ease-in-out'>Hold My Beer CO</p>
            ...
            <div className="md:col-span-10 lg:col-span-9 grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              {/* <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <a className="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" href="https://applypro.ai">
                     ApplyPro.ai
                    </a>
                  </li>
                  <li className="mb-1">
                    <a className="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" href="https://u-mail.ai">
                      UMail
                    </a>
                  </li>
                  <li className="mb-1">
              ...
              <div className="text-sm">
                ...
                <ul>
                  ...
                  <li className="mb-1">
                    <a className="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" href="https://www.amazon.com/JYVNCZ-Reversible-Pillowcase-Decorative-Inches%EF%BC%88Gold%EF%BC%89/dp/B0BG8HW1DV/ref=asc_df_B0BG8HW1DV/?tag=hyprod-20&linkCode=df0&hvadid=693769995797&hvpos=&hvnetw=g&hvrand=12613000348124047769&hvpone=&hvptwo=&hvqmt=&hvdev=c&hvdvcmdl=&hvlocint=&hvlocphy=9028890&hvtargid=pla-2068535422238&mcid=542f2c86667831afae14b3cc9ec173fe&th=1" target="_blank">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-600 dark:text-gray-400 text-sm mr-4">&copy; Hold My Beer CO. All rights reserved.</div>
          </div>
        </div>
      </div>
    </footer>
