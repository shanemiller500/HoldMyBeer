...
export default function UMailLandingPage() {
  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <main className="bg-white dark:bg-gray-900 transition-colors duration-300">
        ...
        <section className="relative pb-16 md:pb-20 bg-gray-100 dark:bg-gray-800">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            {/* Section header */}
            <div className="text-center mb-10" data-aos="fade-up">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">
                Explore the comprehensive range of features that makes UMail truly exceptional.
              </p>
            </div>
  ...
  {/* 2 */}
  <div className="absolute font-medium px-4 py-2 text-white dark:text-teal-500 bg-gradient-to-tr from-teal-500 to-teal-400 dark:bg-teal-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-1 mt-28">
  ...
  {/* 4 */}
  <div className="absolute font-medium px-4 py-2 text-white dark:text-indigo-500 bg-gradient-to-tr from-indigo-500 to-indigo-400 dark:bg-indigo-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-3 mt-72">
  ...
  {/* 11 */}
  <div className="absolute font-medium px-4 py-2 text-white dark:text-red-500 bg-gradient-to-tr from-red-500 to-red-400 dark:bg-red-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-10 mt-60 top-12">
    Custom Message Styles
  </div>
  
  {/* 12 */}
  <div className="absolute font-medium px-4 py-2 text-white dark:text-indigo-500 bg-gradient-to-tr from-indigo-500 to-indigo-400 dark:bg-indigo-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-11 mt-28">
  ...
  {/* 15 */}
  <div className="absolute font-medium px-4 py-2 text-white dark:text-gray-900 bg-gradient-to-tr from-pink-500 to-pink-400 dark:bg-pink-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-14 mt-24 top-60">
    ...
    End-to-End Encryption &amp; Zero Ads
        ...
        <section className="relative py-16 md:py-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8" data-aos="fade-up" data-aos-delay="200">
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-teal-500 mb-2">Private Sync</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  UMail keeps your communication synced across devices without compromising privacy. Your data is never shared with third parties.
                </p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-teal-500 mb-2">Confidential Feedback</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  UMail enhances your workflow while safeguarding your data. Our encryption protects your communications without sharing anything with AI learning systems.
                </p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <section className="relative py-16 md:py-20 bg-teal-500">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-lg md:text-xl text-white mb-8" data-aos="fade-up" data-aos-delay="100">
